...
- If you have 10 original attributes, you start with 10 principal components. However, you might find that the first 3 components explain 95% all of the variance. By keeping only those 3, you reduce your 10D problem to a 3D problem while losing only a tiny fraction of the original information.
